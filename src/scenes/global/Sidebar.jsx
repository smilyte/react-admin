    ...
    return (
        <Box
            sx={{
                ...
                "& .pro-inner-item":{ padding: "5px 35px 5px 20x !important;"},
            ...
            <ProSidebar collapsed={isCollapsed}>
                <Menu iconShape="square">
                    ...
                    {!isCollapsed &&(
                        <Box mb="25px">
                            ...
                            <Box textAlign="center">
                                ...
                                <Typography variant="h5" color={colors.greenAccent[500]}>Wonky Titles</Typography>
                            </Box>
                        </Box>
                    )}
                    ...
                    <Box paddingLeft={isCollapsed ? undefined : "10%"}>
                        ...
                        <Item title="Invoices Balances" to="/invoice" icon={<ReceiptOutlinedIcon/>} selected={selected} setSelected={setSelected} />
